...
namespace DictionaryApplication.Web.Controllers
{
    public class QuestionsController : Controller
    {
        ...
        public QuestionsController(AppDbContext context, Cache dictionary)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("Id,Text,Answer")] Question question)
        {
            if (ModelState.IsValid)
            {
                _context.Add(question);
                await _context.SaveChangesAsync();
                _dictionary.RefreshAsync();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Text,Answer")] Question question)
        {
            if (id != question.Id)
            {
                return NotFound();
